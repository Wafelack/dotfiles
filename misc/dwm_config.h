...
static const char *fonts[]          = { "unifont:size=12:antialias=true" };
static const char dmenufont[]       = "unifont:size=12:antialias=true";
static const char *colors[][3]      = {
	/*               fg         bg         border   */
	[SchemeNorm] = { "#eceff4", "#2e3440", "#22272e" },
	[SchemeSel]  = { "#eceff4", "#2e3440", "#a3be8c" },
};

/* tagging */
static const char *tags[] = { "pa", "re", "ci", "vo", "mu", "xa", "ze", "bi", "so" };
...
static Key keys[] = {
  ...
  { MODKEY|ShiftMask,             XK_i,      spawn,          {.v = increasevol} },
  { MODKEY|ShiftMask,             XK_d,      spawn,          {.v = decreasevol} },
